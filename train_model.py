...
# â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
SENSOR_LABELS = {
    's2':  'T24 â€” Fan Inlet Temperature (Â°R)',
    's3':  'T30 â€” LPC Outlet Temperature (Â°R)',
    's4':  'T50 â€” HPC Outlet Temperature (Â°R)',
    's6':  'P30 â€” Total Hydraulic Pressure (psia)',
    's7':  'Nf  â€” Physical Fan Speed (rpm)',
    's8':  'Nc  â€” Physical Core Speed (rpm) [Bypass Ratio proxy]',
    's9':  'epr â€” Engine Pressure Ratio',
    's11': 'Ps30 â€” HPC Outlet Static Pressure (psia)',
    's12': 'phi â€” Fuel-Air Ratio (pps/psi)',
    's13': 'NRf â€” Corrected Fan Speed',
    's14': 'NRc â€” Corrected Core Speed',
    's15': 'BPR â€” Bypass Ratio',
    's17': 'bleed â€” HPT Coolant Bleed',
}
...
ensemble_configs = [
    {
        ...
        'desc': 'High depth + moderate LR â€” captures complex non-linear degradation curves',
    ...
    },
    {
        ...
        'desc': 'Low depth + low LR + high n â€” biased toward smooth, generalizable trends',
    ...
    {
        'name': 'WideAggressive',
        'desc': 'High depth + high LR â€” captures sharp regime transitions near end-of-life',
    ...
    },
    {
        ...
        'desc': 'Heavy regularization + gamma pruning â€” pessimistic, prevents overconfidence',
    ...
    },
    {
        ...
        'desc': 'Mid-range all params â€” anchors the ensemble mean near the true RUL',
...
metadata = {
    ...
    # Fleet telemetry statistics â€” used by /predict temporal shim
    ...
    # Fleet sensor baseline â€” used by Z-score anomaly detection
